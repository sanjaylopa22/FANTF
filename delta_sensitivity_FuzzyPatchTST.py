"""
FANTF Delta Sensitivity Analysis Script — PatchTST+FAN
=======================================================
Purpose : Vary delta in {0.1, 0.3, 0.5, 0.7, 1.0} across
          noise levels {0%, 5%, 10%, 20%} on Exchange Rate
          and ETTh1 datasets using PatchTST+FAN backbone.
...
def save_results(results,
                 output_path='delta_sensitivity_patchtst_results.csv'):
    if not results:
...
def print_table(results):
    ...
    print("\n" + "="*80)
    print("DELTA SENSITIVITY SUMMARY — PatchTST+FAN")
...
if __name__ == '__main__':
    print("FANTF Delta Sensitivity Analysis — PatchTST+FAN")
